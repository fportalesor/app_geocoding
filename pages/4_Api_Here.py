...
st.markdown("""<p style="text-align:center;"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/HERE_logo.svg/1200px-HERE_logo.svg.png"
alt="whatever" width="150" height= "150"></p>""", unsafe_allow_html=True)
...
@st.cache_data()
def CONSULTA_API_HERE(api_key_input, df_input, reg_select):
...
with container:
    ...
    if api_key_input:
        if st.button('Comenzar'):
            ...
            join = CONSULTA_API_HERE(api_key_input, df, region_select)
