...
- Para crear su token de acceso debe ingresar a [www.mapbox.com](www.mapbox.com). En el costado superior derecho encontrará la opción para registrarse y crear una cuenta (Sign up).
- La cuenta se activará una vez ingrese al link de verificación que se envió al e-mail que registró.
- Con la cuenta activada podrá iniciar sesión. En la página principal ([https://account.mapbox.com/](https://account.mapbox.com/)) encontrará el token de acceso público (referencia en la figura 2). Este se debe copiar y pegar en la aplicación.
...
- Para crear su token de acceso debe ingresar a [https://cloud.google.com/](https://cloud.google.com/) y dar click en "Empezar gratis".
...
- Luego de haber ingresado sus datos su cuenta gmail estará vinculada. Para visualizar o crear su api key debe dirigirse a [https://console.cloud.google.com/projectselector2/apis/credentials?](https://console.cloud.google.com/projectselector2/apis/credentials?). Allí deberá seleccionar la opción "My First Project". En la nueva página encontrará la opción "CREAR CREDENCIALES". Luego seleccionar "Clave de API". Finalmente debe dar click en el nombre de la clave API y allí encontrará el dato a copiar.
...
- Para crear su token de acceso debe ingresar a [https://developer.tomtom.com/](https://developer.tomtom.com/). En el costado superior derecho encontrará la opción para registrarse y crear una cuenta (Register).
...
- Para crear su token de acceso debe ingresar a [https://developer.here.com/](https://developer.here.com/) y dar click en "Get started for free".
...
- Para obtener el token de acceso o api key, ingresar a [https://platform.here.com/admin/apps](https://platform.here.com/admin/apps). Dar click en "Register new app". Ingresar un nombre. En la opción default access to a project, seleccionar No Project (en principio. De igual modo lo puede asociar a un proyecto). Luego dar click en Register.
...
- Para crear su token de acceso debe ingresar a [https://www.bingmapsportal.com/](https://www.bingmapsportal.com/) y dar click en "Sign in".
