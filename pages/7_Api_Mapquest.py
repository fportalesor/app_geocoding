...
@st.cache_data()
def CONSULTA_API_MAPQUEST(api_key_input, df_input, reg_select):
...
with container:
    ...
    if api_key_input:
        if st.button('Comenzar'):
            ...
            join = CONSULTA_API_MAPQUEST(api_key_input, df, region_select)
