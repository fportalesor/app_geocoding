...
@st.cache_data()
def CONSULTA_API_OSM(api_key_input, df_input, reg_select):
...
with container:
    ...
    if api_key_input:
        if st.button('Comenzar'):
            ...
            join = CONSULTA_API_OSM(api_key_input, df, region_select)
...
3) Ingresar correo electrónico y luego presionar Enter.
